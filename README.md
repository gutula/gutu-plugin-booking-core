...
| Primary focus | reservation staging, hold confirmation, slot conflict safety |
...
- Required plugins: `auth-core`, `org-tenant-core`, `role-policy-core`, `audit-core`, `portal-core`
- Recommended plugins: none
